...
* @access   public
*/
class soapclienttx extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclienttx($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
