...
<p><em>Note: A basic knowledge of the functions and terms associated with an institutional
  research repository is assumed within this User Guide. Where a more detailed
  explanation of a term is required please refer to the Glossary section of this
document.</em></p>
<p><strong>Table of Contents</strong></p>
<ol>
  <li><strong>Logging On</strong></li>
  <li><strong>Activate Datastream</strong></li>
  <li><strong>De-Activate Datastream</strong></li>
  <li><strong>Batch Content Ingest</strong></li>
  <li><strong>Batch Metadata Editing</strong></li>
...
<p><em>(from fedora doc) The user can enter a word or a phrase into the search box.
...
<p><em>Ie. &quot;market reform&quot; may retrieve all objects where that exact
  ...
  that order.</em></p>
<p><em>Note: Each object with an automatic FULLTEXT datastream (such as pdf or word.doc
  files) will also search across that full text. You may not see why you have
retrieved documents until you have displayed the full content of the object.</em></p>
...
<ol>
  ...
  <li>    File naming convention for an object containing multiple content files:
      PID.XXXX, PIDa.XXXX)</li>
</ol>
