...
$agent= new Agent();
$xml_output  = $agent->describeRepository();
//print_r($xml_output);
//print_r($_SERVER['HTTP_HOST']);
//print_r($_SESSION['pidNamespace']);
if($xml_output)
		{

			$html_output .= $agent->transform("./stylesheets/describe.xslt", $xml_output);
...
<div id="content">
	...
	<p class="about"><?php echo $html_output;?></p>
  <hr/>
<div id="footer">
